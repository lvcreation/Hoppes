...
<head>
   ...
   <style>
      ...
      <script src="{{asset('clientSHop/js/cdnTailwindcss.js')}}"></script>
</head>
<body>
   <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
      ...
      <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
         <div class="relative flex">
            ...
            <input type="text" placeholder="Write your message!" id="message" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">

            <input type="text" placeholder="pseudo" id="nickname" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3 ml-3">
            <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
               ...
               <button type="button" id="submitButton" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
