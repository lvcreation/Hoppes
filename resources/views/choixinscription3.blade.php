...
<div class="main-panel ">
  <div class="content-wrapper ">
    <div class="card ">
      <div class="card-body">
        <h4 class="card-title"> L'étudiant inscrit aujourd'hui est : </h4>
         ...
         <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="liste">
                <ul>
                  <li><a href="{{route('inscrmois')}}">Tous</a></li>
                  @foreach ($categories as $categor)
                    <li><a href="{{url('choix_inscription3/'.$categor->nom)}}">{{$categor->nom}}</a></li>              
                  @endforeach
                </ul>
              </div>
            </div>
            ...
            <div class="table-responsive w-100">
              ...
              <table   width="150%" border="1">
                ...
                <tbody>
                  ...
                  @if ($studentsmois)
                      @foreach ($studentsmois as $etudiant)
                          <tr>
