...
<html lang="en">
  ...
  <body>
    ...
    <script src="{{asset('clientSHop/js/all.js')}}"></script>
    <script src="{{asset('clientSHop/js/minified/gsap.min.js')}}"></script>
    <script src="{{asset('clientSHop/js/minified/ScrollTrigger.min.js')}}"></script>
    <script src="{{asset('clientSHop/js/minified/ScrollToPlugin.min.js')}}"></script>
