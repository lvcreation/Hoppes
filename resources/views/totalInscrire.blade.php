...
<div class="main-panel ">
  <div class="content-wrapper ">
    <div class="card ">
      <div class="card-body">
        <h4 class="card-title"> 
          L'étudiant inscrit total est : 
            {{-- @foreach ($Tetudiant as $etude) --}}
         ...
         <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="liste">
                <ul>
                  <li><a href="{{route('Inscriptions')}}">Tous</a></li>
                  @foreach ($categories as $categor)
                    <li><a href="{{url('choix_inscription4/'.$categor->nom)}}">{{$categor->nom}}</a></li>              
                  @endforeach
                </ul>
              </div>
            </div>
